...
execute if entity @e[type=marker, tag=chess.capturable, tag=chess.black, predicate=chess:game_id] run tag @s add chess.whiteCanMove
execute if entity @e[type=marker, tag=chess.capturable, tag=chess.white, predicate=chess:game_id] run tag @s add chess.blackCanMove
