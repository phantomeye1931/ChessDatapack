...
execute unless entity @n[type=interaction, tag=chess.piece, distance=...2] positioned ^ ^ ^1.2 align xyz positioned ~.5 ~ ~.5 run function chess:pieces/movement/on_select/valid/trace_spots