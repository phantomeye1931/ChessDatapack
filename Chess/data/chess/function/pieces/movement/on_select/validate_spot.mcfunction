...
## No check
execute as @s[tag=!chess.existsCheck, tag=!chess.king] run function chess:pieces/movement/on_select/mark_valid
execute as @s[tag=!chess.existsCheck, tag=chess.king, tag=!chess.spotIsVulnerable] run function chess:pieces/movement/on_select/mark_valid
...
execute as @s[tag=chess.king, tag=!chess.spotIsVulnerable] run function chess:pieces/movement/on_select/mark_valid

# Not king; Piece is origin of check
execute as @s[tag=!chess.king] run tag @n[type=interaction, tag=chess.checkOrigin, distance=...5] add chess.capturable

# Not king; Spot is on the path to check
execute as @s[tag=!chess.king, tag=chess.white] if entity @n[type=marker, tag=!chess.white, tag=chess.checkPath, distance=...5] run function chess:pieces/movement/on_select/mark_valid
execute as @s[tag=!chess.king, tag=chess.black] if entity @n[type=marker, tag=!chess.black, tag=chess.checkPath, distance=...5] run function chess:pieces/movement/on_select/mark_valid
